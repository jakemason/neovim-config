...
call s:HL('MatchParen',      'special',    'none',       'none')
...
call s:HL('Statement',       'lemon',      'none',       'none')
call s:HL('String',          'string',     'none')
call s:HL('Todo',            'lemon', 'none')
...
call s:HL('TabLineSel',      'foreground', 'statusline', 'none')
...
call s:HL('Title',           'lemon',      'none',       'none')
...
call s:HL('htmlTagName',     'lemon',      'none',       'none')
call s:HL('htmlTag',         'foreground', 'none')
call s:HL('htmlArg',         'function',   'none')


call s:HL('IncSearch',  'special', 'background', 'reverse,none')
call s:HL('Search',     'special', 'background', 'reverse,none')
call s:HL('Substitute', 'special', 'background', 'reverse,none')
call s:HL('SpellBad',   'none',   'none',       'none,underline')
call s:HL('SpellCap',   'error',   'none',       'none,underline')
call s:HL('SpellLocal', 'special', 'none',       'none,underline')
call s:HL('SpellRare',  'special', 'none',       'none,underline')
